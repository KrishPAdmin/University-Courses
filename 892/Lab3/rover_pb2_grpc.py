...
class GroundControlStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetCommandStream = channel.unary_stream(
                '/rover.GroundControl/GetCommandStream',
        ...
        self.GetMineSerialNumber = channel.unary_unary(
                ...
                response_deserializer=rover__pb2.MineSerialReply.FromString,
                _registered_method=True)
...
def add_GroundControlServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetMineSerialNumber': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=rover__pb2.MineSerialReply.SerializeToString,
            ),
    }
...
class GroundControl(object):
    ...
    def GetMineSerialNumber(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            rover__pb2.MineSerialReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
